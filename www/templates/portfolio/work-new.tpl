			...
			<div class="container add-works pl-0 pr-0 pt-80 pb-120">
				<div class="row ml-0 mr-0">
					<div class="col-10 offset-1 pl-0 pr-0">
						...
						<form class="add-works__form mt-40" action="<?=HOST?>portfolio/work-new" method="POST" enctype="multipart/form-data">
							<div class="add-works__form-item mb-30">
								<label class="label" for="field-work-name">Название</label>
								<input class="input" name="title" id="field-work-name" type="text" placeholder="Введите название работы" value="<?=@$_POST['name']?>" />
							</div>
							<div class="add-works__form-item mb-30">
							...
							<div class="row ml-0 mr-0 mt-30">
								<input class="button button-save mr-20" type="submit" name="workNew" value="Сохранить" />
