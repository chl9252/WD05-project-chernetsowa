			...
			<div class="footer__container">
				<div class="row ml-0 mr-0">
					...
					<div class="col-3 no-paddings">
						<nav class="footer__nav"><a href="<?=HOST?>">Главная</a><a href="<?=HOST?>about">Обо мне</a><a href="<?=HOST?>works">Работы</a><a href="<?=HOST?>blog">Блог</a><a href="<?=HOST?>contacts">Контакты</a></nav>
					</div>
