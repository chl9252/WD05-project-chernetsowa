<div class="container pb-120 pt-80 pl-0 pr-0">
		<div class="row">
			<div class="col-10 offset-1">
				...
				<form enctype="multipart/form-data" class="mt-35" method="POST" action="<?=HOST?>profile-edit">
					...
					<div class="user-edit-wrapper mt-30">
						...
						<div class="user-edit-buttons mt-30">
							<input class="button button-save" type="submit" name="profile-edit" value="Сохранить" />
							<a href="<?=HOST?>profile" class="button" name="cancel-profile-edit">Отмена</a>
						</div>
					</div>
				</form>
			</div>
